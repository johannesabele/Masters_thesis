...
class DisentangledSpritesDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        label = self.latents_classes[idx].astype(np.int16)
...
train_data, test_data = load_dsprites(dir = "C:\\Users\\jojoa\\OneDrive\\Dokumente\\Master Statistik\\Masterarbeit\\Programming\\VAE\\Data_sets\\")
